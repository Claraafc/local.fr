...
function magbook_admin_css (){

  wp_enqueue_style( 'magbook-admin-css', get_template_directory_uri() . '/css/admin/admin.css' );

}

add_action( 'admin_enqueue_scripts', 'magbook_admin_css' );
...
function magbook_admin_notice() {
  ...
  if ( !get_user_meta( $current_user_id, esc_html( $theme->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
    ?>
    <div class="notice magbook-notice">
